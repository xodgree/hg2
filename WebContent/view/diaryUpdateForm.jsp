		...
		<!-- Main -->
			...
			<input type = "hidden" name = "num" form="submitForm" value="${num}">
				...
				<div class="inner inputbox">
					<textarea name="content" id="message" placeholder="Enter your message" rows="13"  form="submitForm">${diary.content}</textarea>
				</div>
				...
				<div style="text-align: center; margin-top: 10px; margin-bottom: 10px;">
					<form id="submitForm" action="diaryUpdatePro" method="post" enctype="multipart/form-data"></form>
