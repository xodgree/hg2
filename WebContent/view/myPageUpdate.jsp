	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method = "post" name ="myPage" action="myPageUpdatePro">
					...
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						...
						<input class="input100" type="text" name="name" value="${member.name}" placeholder="Name...">
					...
					<div class="container-login100-form-btn">
						...
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" type="button" onclick="location.href = 'memberDelete'">
								탈퇴
							</button>
						</div>
