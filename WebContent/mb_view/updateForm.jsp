                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="name" class="form-control" id="name"
                               placeholder="name" required autofocus value ="${member.name}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="email" class="form-control" id="email"
                               placeholder="you@example.com" required autofocus value ="${member.email}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-6">
              <input type="submit" class="btn btn-warning btn-sm" value="회원수정" >
                ...
                <input type="button" class="btn btn-primary btn-sm" value = "회원목록"
                 onclick = "document.location.href='list?num=${member.num}'">
            </div>
        </div>
    </form>
</div>
